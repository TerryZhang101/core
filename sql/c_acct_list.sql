-- ----------------------------
-- Table structure for c_acct_list
-- 表字段与c_acct_jour一致，c_acct_jour可以每日清理前一日数据，而c_acct_list数据不清理，永久保留。
-- 登记交易明细信息。
-- ----------------------------
DROP TABLE IF EXISTS c_acct_list;
CREATE TABLE c_acct_list
(
  ...
  ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='分录明细表';
