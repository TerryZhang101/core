...
import com.nms.core.util.IOUtils;
...
class HttpKitExt {
    ...
    protected static String uploadMedia(String url, File file, String params) throws IOException {
        ...
        if (StrKit.notBlank(params)) {
            ...
            out.write(params.getBytes(CharsetsKit.UTF_8));
        }
        byte[] end_data = ("\r\n--" + BOUNDARY + "--\r\n").getBytes();
        out.write(end_data);
        out.flush();
        ...
        BufferedReader read = new BufferedReader(new InputStreamReader(in, CharsetsKit.UTF_8));
    ...
    protected static String postSSL(String url, String data, String certPath, String certPass) {
        ...
        try {
            ...
            out.write(data.getBytes(CharsetsKit.UTF_8));
            out.flush();

            inputStream = conn.getInputStream();
            reader = new BufferedReader(new InputStreamReader(inputStream, CharsetsKit.UTF_8));
